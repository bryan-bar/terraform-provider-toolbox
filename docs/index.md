...
* [Ansible provider by Ansible](https://registry.terraform.io/providers/ansible/ansible/latest/docs) - Execute an ansible-playbook from the local instance(controller) and expose output for use in terraform.
